...
public class IndexWheel(string Name, params int[] Stops)
{
    ...
    public static IndexWheel P305 { get; } = new(nameof(P305), 5, 3, 2, 3, 0, 3, 1, 3, 4, 3, 2, 3, 0, 2, 3, 2, 3, 4, 1, 3, 2, 3);
    public static IndexWheel P306 { get; } = new(nameof(P306), 5, 1, 4, 0, 4, 3, 4, 0, 4, 1, 4, 0, 4, 0, 4, 1, 4, 3, 4, 2, 4, 0);
    public static IndexWheel P307 { get; } = new(nameof(P307), 5, 1, 2, 1, 2, 0, 2, 1, 2, 1, 2, 4, 2, 1, 2, 3, 2, 0, 2, 1, 2, 1);
    public static IndexWheel P347 { get; } = new(nameof(P347), 5, 1, 4, 0, 4, 3, 4, 0, 4, 1, 4, 0, 3, 0, 4, 1, 4, 3, 4, 2, 4, 0);
    ...
    public static IndexWheel GetIndexDisc(IndexWheelNumber Number) => Number switch
    {
        ...
        IndexWheelNumber.P305 => P305,
        IndexWheelNumber.P306 => P306,
        IndexWheelNumber.P307 => P307,
        IndexWheelNumber.P347 => P347,
